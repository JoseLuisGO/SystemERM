...
INSERT INTO `producto` VALUES ('ARN-SM369 ','INVENTARIO ERM','M00515A003 ','ARNES P/TECLADO MAESTRO ',350,200,24,'1','Pesos',0),('BAR-RM177 ','INVENTARIO ERM','331898-001 ','BARRIER PARA TLS 350 ',400,210,16,'1','Pesos',0),('BOT-SM241 ','INVENTARIO','BN-75-100 ','BOTA FLEXIBLE DE 3/4\" O 1\" ',120,60,20,'1','Pesos',0),('BOT-SM241/1','SEM','BN-75-100','BOTA FLEXIBLE DE 3/4\" O 1\"',120,75,10,'2','Pesos',0),('BOT-SM241BA ','INVENTARIO','BN-300 ','BOTA FLEXIBLE DE 3\" (PENETRACION RUBERSTONNE) ',8265,4950,5,'1','Pesos',0),('BOT-SM241BN ','INVENTARIO','BN-200','BOTA FLEXIBLE DE 2\" (NACIONAL) ',823.58,600,8,'3','Pesos',0),('CAL-SM317','TAMTO','TN-7','CALIBRADOR PERSONAL',450,360,15,'3','Pesos',0),('CAL-SM318C ','TAMTO','TN-6C ','CALIBRADOR LARGO 30CM (150psi) cuello CORTO ',65,40,20,'3','Pesos',0),('CAL-SM71 ','CASTILLO','102049 ','LEXAN PARA PRESET TEAM GASOLINA ',100,45,50,'1','Pesos',0),('CED-RM370 ','RNB','1801DRE ','CEDAZO PARA DISPENSARIO WAYNE  ',280,140,10,'1','Pesos',0),('CNC-SM462B ','ARTE','MS-XP-200-200 ','CONECTOR DE 2\" ESPIGA X 2\" MACHO C/DEST. ',800,350,4,'2','Pesos',0),('COD-SM279 ','INVENTARIO','80TT ','CODO HERMETICO P/DESCARGA 3\"CIVACON REC VAP ',2800,1200,1,'2','Pesos',0),('RFB-114720G ','INVENTARIO','GL73054 ','PISTOLERA BENNETT MCA GLOBAL (INCLUYE 2 RUEDAS, 1 RESORTE, 1 IMAN, 3 PERNOS) ',400,180,5,'2','Pesos',0),('SEN-SM266 ','C-ING','LS-3AB ','SENSOR UNIVERSAL DE LIQUIDOS PARA USARSE EN CONTENEDOR Y/O ESPACIO ANULAR GEMS ',850,590,2,'1','Pesos',0);
...
-- Dump completed on 2018-08-30 22:05:49
